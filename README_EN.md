...
The wave of tech-sector layoffs that swept through 2022 and 2023 was, by almost any historical measure, unusual. What made it particularly interesting from a research standpoint was its macroeconomic backdrop: GDP was still growing, aggregate unemployment had not risen meaningfully, and no recession had technically begun. The layoffs were driven instead by firm-level structural pressures — the reckoning after pandemic-era overhiring, a shift in investor appetite toward profitability as interest rates climbed, and the collective imagination sparked by ChatGPT about whether AI was about to replace large swaths of white-collar work.

This context makes the stock price implications of layoff announcements genuinely difficult to predict. The textbook efficient markets view would say that if layoffs are simply the inevitable correction to overhiring, a rational market should have priced this in well before any announcement date — the public disclosure itself shouldn't move prices. But in practice, the market's interpretation of "why this company is cutting jobs" is far from uniform. Some investors read layoffs as disciplined cost restructuring and a positive signal for margins; others read them as a distress signal, a sign that the business is struggling. Which interpretation dominates the price tends to depend on the company's underlying quality, the prevailing market mood, and the narrative frame that the financial media happens to apply at the time.

The arrival of ChatGPT on November 30, 2022 added a genuinely new dimension to this interpretive question. Almost overnight, it shifted the dominant public frame around tech layoffs: where "tech company cuts jobs" had previously connoted failure or decline, the new narrative became "tech company embraces AI-driven transformation." The question this study sets out to answer is whether that narrative shift ever made it into actual market pricing — whether investors, after ChatGPT, began systematically rewarding AI-linked layoffs differently than they had before.
